...
def getReq1(control, anio):
    movies_anio=model.getReq1(control['model'],anio)
    return movies_anio

def getReq2(control, anio):
    series_anio=model.getReq2(control['model'],anio)
    return series_anio

def getReq3(control,actor):
    actor=model.getReq3(control['model'],actor)
    return actor

def getReq4(control,genero):
    genero=model.getReq4(control['model'],genero)
    return genero
...
def getReq7(control, top):
    return model.getReq7(control['model'], top)
